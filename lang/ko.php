...
return array(
    ...
    'ip'             => "은(는) 올바르지 않은 IP주소입니다.",
    'ipv4'           => "은(는) 올바르지 않은 IPv4주소입니다.",
    'ipv6'           => "은(는) 올바르지 않은 IPv6주소입니다.",
    ...
    'instanceOf'     => "은(는) '%s'의 객체여야 합니다.",
    'containsUnique' => "은(는) 유일한 요소만 포함해야 합니다.",
    'requiredWith'   => "을(를) 입력해야 합니다.",
    'requiredWithout'=> "을(를) 입력해야 합니다.",
    'subset'         => "은(는) 목록에 없는 요소를 포함해야 합니다.",
    'arrayHasKeys'   => "의 배열에 필요한 키가 없습니다.",
);
